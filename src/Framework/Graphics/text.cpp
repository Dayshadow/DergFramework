...
void Text::draw(const glm::vec3& p_textColor, DrawSurface& p_target, DrawStates& p_drawStates) {
	...
	s_gs.textShader.setTexUniform(s_gs.text_fontAtlasUniformLoc, 0);
	...
	p_drawStates.attachShader(&s_gs.textShader);
	s_gs.textShader.setVec3Uniform(s_gs.text_textColUniformLoc, p_textColor);
